...
public class ClientRepository
{
    ...
    internal async Task CreateAsync(CreateClientModel model)
    {
    ...
    internal async Task UpdateAsync(ClientModel model)
    {
        ArgumentNullException.ThrowIfNull(model.AllowedScopes, nameof(model.AllowedScopes));
