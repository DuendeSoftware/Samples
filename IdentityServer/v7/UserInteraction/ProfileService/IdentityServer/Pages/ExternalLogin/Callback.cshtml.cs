...
public class Callback : PageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        // this is only an example, so the claim(s) you need might be something more
        // specific to your use case and/or workflow.
        var picture = externalUser.FindFirst("picture");
        if (picture != null)
        {
            additionalLocalClaims.Add(picture);
        }
